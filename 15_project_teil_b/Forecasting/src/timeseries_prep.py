...
def dataframe_to_timeseries(
    ...
    # fehlende Werte mit interpolierten Werten auffüllen anstatt mit nullen(0)
    target_series_filled = fill_missing_values(target_series)
    covariates_series_filled = fill_missing_values(covariates_series)

    return target_series_filled, covariates_series_filled
